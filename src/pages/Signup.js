...
const { signUp } = UserAuth();
  ...
  return (
    ...
    <div className='login-con'>
        <h1 className={theme ? 'text-white' : 'text-black'}>Register On Coinie</h1>
        <p className={theme ? 'text-light-gray':'text-dark-gray'}>Start your awesome journey to profit on Coinie</p>
        <span className='signin-link'>
            <BiLockOpen size={33} style={{color:'#fff',background:'#58bd7d',borderRadius:'50%',padding:'2px'}}/>
            <small className={theme ? 'text-white' : 'text-black'}><span>https://</span>accounts.coinie.com/signup</small>
        </span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='to-signup'>
            <p className={theme ? 'text-white' : 'text-black'}>Already A Member?</p>
